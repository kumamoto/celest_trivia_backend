...
class CelestVariables {
  ...
  /// The value of the `TURSO_DATABASE_URL` environment variable.
  String get tursoDbUrl => context.expect(const env('TURSO_DATABASE_URL'));

  /// The value of the `TURSO_DATABASE_JWT_TOKEN` environment variable.
  String get tursoDbJwtToken =>
      context.expect(const env('TURSO_DATABASE_JWT_TOKEN'));
}
